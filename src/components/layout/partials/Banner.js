    ...
    <>
      {bannerOpen && (
        <div {...props} className="banner">
          ...
          <div className='banner-container'><a className="banner-link banner-link-white" href="https://github.com/Broken99Records/open-react-template" target="_blank" rel="noopener noreferrer">Download<span className="banner-hide-on-sm"> on GitHub</span></a> <span className="banner-separator">or</span> <a className="banner-link banner-link-green" href="https://Broken99Records.com/open-pro/" target="_blank" rel="noopener noreferrer">Check Premium Version</a></div>
